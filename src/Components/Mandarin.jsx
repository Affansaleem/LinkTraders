      ...
      <div className="contact-us-container">
        <div className="background-image">
          ...
          <div className="content">
            ...
            <h1 className="font-bold text-6xl">ORANGES</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            <span className="font-extrabold text-5xl">MANDARIN ORANGE </span>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          ...
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">PACKAGING </span>
