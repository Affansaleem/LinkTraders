    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img src="images\rice\rice.jpg" alt="images\rice\rice.jpg" />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              BEST QUALITY
            </p>
            <h1 className="font-bold text-6xl">RICE</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20 mx-20">
          ...
          <img
            src="images\rice\rice-1.png"
            alt="images\rice\rice-1.png"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          ...
          <img
            src="images\rice\rice-2.png"
            alt="images\rice\rice-2.png"
            className="col-span-1"
          />
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images\rice\rice-3.png"
            alt="images\rice\rice-3.png"
            className="col-span-1"
          />
