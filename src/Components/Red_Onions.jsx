    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img
            src="images/red-onions/red-onion.jpg"
            alt="images/red-onions/red-onion.jpg"
          />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              RED
            </p>
            <h1 className="font-bold text-6xl">ONIONS</h1>
          </div>
        </div>

        <div className="grid grid-cols-2  items-center p-20 mx-20">
          <div className="col-span-1 mx-10">
            <span className="font-extrabold text-5xl">RED </span>
            <span className="font-thin text-5xl">ONIONS</span>
          ...
          <img
            src="images/red-onions/red-onion-1.png"
            alt="images/red-onions/red-onion-1.png"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            <span className="font-extrabold text-5xl">ONION</span>
            <span className="font-thin text-5xl"> PROCESSING</span>
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images/red-onions/red-onion-2.png"
            alt="images/red-onions/red-onion-2.png"
            className="col-span-1"
          />
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images/red-onions/red-onion-3.png"
            alt="images/red-onions/red-onion-3.png"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">RED ONION </span>
            <span className="font-thin text-5xl">PACKAGING AND STORAGE</span>
            <p className="text-sm font-light text-stone-500 mt-3">
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-3">
            <span className="font-extrabold text-5xl">OUR RED ONION </span>
            <span className="font-thin text-5xl">EXPORT AND SHIPMENT </span>
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images/red-onions/red-onion-4.png"
            alt="images/red-onions/red-onion-4.png"
            className="col-span-1"
          />
        </div>
      </div>
