    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img
            src="images\mangoes\mangoes.jpg"
            alt="images\mangoes\mangoes.jpg"
          />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              FRESH & TASTEFUL
            </p>
            <h1 className="font-bold text-6xl">MANGOES</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20 mx-20">
          <div className="col-span-1 mx-10">
            ...
            <span className="font-thin text-5xl">MANGO</span>
          ...
          <img
            src="images\mangoes\mangoes-1.png"
            alt="images\mangoes\mangoes-1.png"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            <span className="font-extrabold text-5xl">MANGO </span>
            <span className="font-thin text-5xl">PRODUCTION</span>
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images\mangoes\mangoes-2.png"
            alt="images\mangoes\mangoes-2.png"
            className="col-span-1"
          />
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images\mangoes\mangoes-3.png"
            alt="images\mangoes\mangoes-3.png"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">CUSTOMIZED </span>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-3">
            <span className="font-extrabold text-5xl">SHIPMENT</span>
            {/* <span className="font-thin text-5xl">EXPORT AND PACKAGING </span> */}
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images\mangoes\mangoes-4.png"
            alt="images\mangoes\mangoes-4.png"
            className="col-span-1"
          />
        </div>
      </div>
