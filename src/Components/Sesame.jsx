    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img src="images\sesame\sesame.jpg" alt="images\sesame\sesame.jpg" />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              BEST QUALITY
            </p>
            <h1 className="font-bold text-6xl">SESAME</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20 mx-20">
          <div className="col-span-1 mx-10">
            ...
            <span className="font-thin text-5xl">SESAME SEEDS</span>
          ...
          <img
            src="images\sesame\sesame-1.png"
            alt="images\sesame\sesame-1.png"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            <span className="font-extrabold text-5xl">TYPES OF </span>
            <span className="font-thin text-5xl">SESAME SEEDS</span>
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images\sesame\sesame-2.png"
            alt="images\sesame\sesame-2.png"
            className="col-span-1"
          />
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images\sesame\sesame-3.png"
            alt="images\sesame\sesame-3.png"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">CUSTOMIZED </span>
            <span className="font-thin text-5xl">PACKAGING AND EXPORT </span>
            <p className="text-sm font-light text-stone-500 mt-3">
        ...
        <div className="grid grid-cols-2  items-center p-20">
          ...
          <img
            src="images\rice\rice-4.png"
            alt="images\rice\rice-4.png"
            className="col-span-1"
          />
        </div>
      </div>
