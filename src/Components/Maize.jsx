    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img src="images/yellow-corn.jpg" alt="rhodes-grass.png" />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              SUPER VALUE
            </p>
            <h1 className="font-bold text-6xl">YELLOW CORN</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20 mx-20">
          <div className="col-span-1 mx-10">
            ...
            <span className="font-thin text-5xl">YELLOW CORN</span>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            ...
            <span className="font-thin text-5xl">LIVESTOCK DIET</span>
            <p className="text-sm font-light text-stone-500 mt-3">
        ...
        <div className="grid grid-cols-2  items-center p-20">
          ...
          <div className="col-span-1 ml-5">
            ...
            <span className="font-thin text-5xl">OF CORN AT SAREMCO</span>
            <p className="text-sm font-light text-stone-500 mt-3">
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-3">
            <span className="font-extrabold text-5xl">QUALITY </span>
            <span className="font-thin text-5xl">MAIZE</span>
            <p className="text-sm font-light text-stone-500 mt-3">
