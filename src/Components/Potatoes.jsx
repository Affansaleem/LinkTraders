    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img src="images/potatoes.jpg" alt="potatoes.jpg" />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              FRESH AND
            </p>
            <h1 className="font-bold text-6xl">TASTEFUL POTATOES</h1>
          </div>
        </div>

        <div className="grid grid-cols-2  items-center p-20 mx-20">
          <div className="col-span-1 mx-10">
            <span className="font-extrabold text-5xl">FRESH </span>
            <span className="font-thin text-5xl">POTATOES</span>
          ...
          <img
            src="images/potatoes/potatoe-1.png"
            alt="images/potatoes/potatoe-1.png"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            <span className="font-extrabold text-5xl">POTATO CULTIVATION</span>
            {/* <span className="font-thin text-5xl">BY LINK TRADERS</span> */}
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images/potatoes/potatoe-2.png"
            alt="images/potatoes/potatoe-2.png"
            className="col-span-1"
          />
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images/potatoes/potatoe-3.png"
            alt="images/potatoes/potatoe-3.png"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">LADY ROSETTA </span>
            <span className="font-thin text-5xl">POTATOES</span>
            <p className="text-sm font-light text-stone-500 mt-3">
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-3">
            <span className="font-extrabold text-5xl">MOZIKA </span>
            <span className="font-thin text-5xl">POTATOES</span>
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images/potatoes/potatoe-4.png"
            alt="images/potatoes/potatoe-4.png"
            className="col-span-1"
          />
        </div>
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images/potatoes/potatoe-5.png"
            alt="images/potatoes/potatoe-5.png"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">SANTE </span>
            <span className="font-thin text-5xl">POTATOES</span>
            <p className="text-sm font-light text-stone-500 mt-3">
              Wheat Straw is used into the feeding program during the pregnant
              cows in their’ second-trimester it is very useful. In this stage,
