    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img
            src="images\turmeric\turmeric.jpg"
            alt="images\turmeric\turmeric.jpg"
          />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              BEST QUALITY
            </p>
            <h1 className="font-bold text-6xl"> TURMERIC</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20 mx-20">
          <div className="col-span-1 mx-10">
            ...
            <span className="font-thin text-5xl">TURMERIC</span>
          ...
          <img
            src="images\turmeric\turmeric-1.jpg"
            alt="images\turmeric\turmeric-1.jpg"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            <span className="font-extrabold text-5xl">HOUSEHOLD</span>
          ...
          <img
            src="images\turmeric\turmeric-2.jpg"
            alt="images\turmeric\turmeric-2.jpg"
            className="col-span-1"
          />
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images\turmeric\turmeric-3.jpg"
            alt="images\turmeric\turmeric-3.jpg"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">HEALTH </span>
            <span className="font-thin text-5xl">SUPPLEMENT</span>
            <p className="text-sm font-light text-stone-500 mt-3">
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-3">
            <span className="font-extrabold text-5xl">COSMETICS</span>
          ...
          <img
            src="images\turmeric\turmeric-4.png"
            alt="images\turmeric\turmeric-4.png"
            className="col-span-1"
          />
        </div>
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images\turmeric\turmeric-5.jpg"
            alt="images\turmeric\turmeric-5.jpg"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">RAW TURMERIC </span>
            <span className="font-thin text-5xl">(TURMERIC FINGERS)</span>
            <p className="text-sm font-light text-stone-500 mt-3">
              Wheat Straw is used into the feeding program during the pregnant
              cows in their’ second-trimester it is very useful. In this stage,
              their requirements for protein and energy are way lower than late
