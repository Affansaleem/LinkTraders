...
import "../Styles/Seasonal_Straw.scss";
import { useEffect, useState } from "react";

function Seasonal_Straw() {
    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img src="images/seasonal-straw.jpg" alt="rhodes-grass.png" />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              SUPER VALUE
            </p>
            <h1 className="font-bold text-6xl">SEASONAL STRAW</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20 mx-20">
          <div className="col-span-1 mx-10">
            ...
            <span className="font-thin text-5xl">SEASONAL STRAW</span>
          ...
          <img
            src="images/seasonal-straw-1.jpg"
            alt="scientist.jpg"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            <span className="font-extrabold text-5xl">MONG </span>
            <span className="font-thin text-5xl">STRAW</span>
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images/seasonal-straw-2.jpg"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images/seasonal-straw-3.jpg"
            alt="rhodes-stock.jpg"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">PEANUT </span>
            <span className="font-thin text-5xl">STRAW</span>
            <p className="text-sm font-light text-stone-500 mt-3">
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-3">
            <span className="font-extrabold text-5xl">CHICKPEAS </span>
            <span className="font-thin text-5xl">STRAW</span>
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images/seasonal-straw-4.jpg"
            alt="our-rhodes.png"
            className="col-span-1"
          />
        </div>
