    ...
    <>
      ...
      <div className="contact-us-container">
        <div className="background-image">
          <img
            src="images\mandarin\mandarin-cover.jpg"
            alt="images\mandarin\mandarin-cover.jpg"
          />
          <div className="content">
            <p className="text-6xl" style={{ fontWeight: 100 }}>
              طازجة ولذيذة
            </p>
            <h1 className="font-bold text-6xl">البرتقال</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20 mx-20">
          <div className="col-span-1 mx-10">
            <span className="font-extrabold text-5xl">
              حول الماندارين / البرتقال{" "}
            </span>
            {/* <span className="font-thin text-5xl">ORANGES</span> */}
          ...
          <img
            src="images\mandarin\mandarin-1.png"
            alt="images\mandarin\mandarin-1.png"
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-5">
            <span className="font-extrabold text-5xl">ساريمكو ماندرين </span>
            <span className="font-thin text-5xl"> لتجهيز البرتقال</span>
            <p className="text-sm font-light text-stone-500 mt-3">
          ...
          <img
            src="images\mandarin\mandarin-2.png"
            alt="images\mandarin\mandarin-2.png"
            className="col-span-1"
          />
        </div>
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <img
            src="images\mandarin\mandarin-3.png"
            alt="images\mandarin\mandarin-3.png"
            className="col-span-1"
          />
          <div className="col-span-1 ml-5">
            <span className="font-extrabold text-5xl">التعبئة </span>
            <span className="font-thin text-5xl">والتغليف </span>
            <p className="text-sm font-light text-stone-500 mt-3">
        ...
        <div className="grid grid-cols-2  items-center p-20">
          <div className="col-span-1 mr-3">
            <span className="font-extrabold text-5xl">شحنة</span>
          ...
          <img
            src="images\mandarin\mandarin-4.png"
            alt="images\mandarin\mandarin-4.png"
            className="col-span-1"
          />
        </div>
      </div>
